...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (str first-name " " last-name " aka " (reduce (fn [a, b] (str a " aka " b)) aliases))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     (let [[[first-name last-name][{street-address :street-address, city :city, state :state}]] [["Test" "Testerson"] [test-address]]]
